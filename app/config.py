...
CLAUDE_DECISION_ENABLED = os.getenv("CLAUDE_DECISION_ENABLED", "false").lower() == "true"
CLAUDE_MODEL = os.getenv("CLAUDE_MODEL", "claude-sonnet-5")
CLAUDE_TIMEOUT_SECONDS = int(os.getenv("CLAUDE_TIMEOUT_SECONDS", "20"))
CLAUDE_MAX_RETRIES = int(os.getenv("CLAUDE_MAX_RETRIES", "2"))
CLAUDE_MIN_SECONDS_BETWEEN_CALLS = int(os.getenv("CLAUDE_MIN_SECONDS_BETWEEN_CALLS", "15"))
CLAUDE_MIN_CONFIDENCE = float(os.getenv("CLAUDE_MIN_CONFIDENCE", "0.62"))
CLAUDE_MIN_POSITION_PERCENT = float(os.getenv("CLAUDE_MIN_POSITION_PERCENT", "0.10"))
CLAUDE_MAX_POSITION_PERCENT = float(os.getenv("CLAUDE_MAX_POSITION_PERCENT", "0.40"))
CLAUDE_REQUIRE_EXISTING_SIGNAL = os.getenv("CLAUDE_REQUIRE_EXISTING_SIGNAL", "true").lower() == "true"
CLAUDE_PAPER_ONLY = os.getenv("CLAUDE_PAPER_ONLY", "true").lower() == "true"
CLAUDE_LOG_PROMPTS = os.getenv("CLAUDE_LOG_PROMPTS", "false").lower() == "true"
